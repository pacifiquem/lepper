...
program
  .name("npx-proj")
  .description(
    "Node.js project-structure manager, developed by pacifiquem@github.com \n\n"
  )
  .usage("command [options]")
  .version(
    `\x1b[1mv${require("../package.json").version}\x1b[0m`,
    "-v, --version",
...
program
  ...
  .action(
    (argument: string, options: { files: string[]; folders: string[] }) => {
      let directory = cwd();
...
program
  ...
  .description(
    "Command to add description to your project And its sub folders ."
  )
  ...
  .option(
    "-m, --message <string>",
    "message you want to add to your description ?"
  )
...
program
  .command("describe")
  .description(
    "Command to display description of your project And its sub folders ."
  )
  .option(
    "-p, --project <string>",
    "project you want to display description of ?"
  )
  .option(
    "-fo, --folder <string>",
    "folder you want to display description of ?"
  )
